...
export const CONTRACT_ABI = [
  ...
  {"anonymous":false,"inputs":[{"indexed":false,"internalType":"uint256","name":"id","type":"uint256"},{"indexed":false,"internalType":"uint256","name":"amount","type":"uint256"},{"indexed":false,"internalType":"string","name":"description","type":"string"},{"indexed":false,"internalType":"string","name":"merchantName","type":"string"},{"indexed":false,"internalType":"string","name":"merchantLocation","type":"string"},{"indexed":false,"internalType":"string","name":"itemizedList","type":"string"}],"name":"NewActiveTransaction","type":"event"},
  ...
  {"inputs":[{"internalType":"uint256","name":"amount","type":"uint256"},{"internalType":"string","name":"description","type":"string"},{"internalType":"string","name":"merchantName","type":"string"},{"internalType":"string","name":"merchantLocation","type":"string"},{"internalType":"string","name":"itemizedList","type":"string"}],"name":"setActiveTransaction","outputs":[],"stateMutability":"nonpayable","type":"function"},
